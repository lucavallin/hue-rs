...
impl std::fmt::Display for ProductArchetype {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::BridgeV2 => write!(f, "bridge_v2"),
...
impl Default for ProductArchetype {
    fn default() -> ProductArchetype {
        Self::BridgeV2
    }
}
