...
/// LightGetAllOfPowerup : Feature containing properties to configure powerup behaviour of a lightsource.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LightGetAllOfPowerup {
    ...
    pub dimming: Option<Box<models::LightGetAllOfPowerupDimming>>,
}

impl LightGetAllOfPowerup {
    /// Feature containing properties to configure powerup behaviour of a lightsource.
    pub fn new() -> LightGetAllOfPowerup {
